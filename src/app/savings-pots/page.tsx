              ...
              <div className="relative">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl p-8 rounded-2xl border border-green-500/20">
                  <form onSubmit={handleCreatePot} className="space-y-6">
                    ...
                    <div>
                      <label className="block mb-2 text-green-400 font-medium">Target Amount (NIBI)</label>
                      <input
                        type="number"
                        value={targetAmount}
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between mt-2 text-sm">
            ...
            <span className="text-green-400 font-medium">
              {formatAmount(pot.currentAmount)} / {formatAmount(pot.targetAmount)} NIBI
            </span>
          </div>
        </div>
