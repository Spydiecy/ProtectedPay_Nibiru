      ...
      <div className="relative bg-black/30 backdrop-blur-xl p-4 rounded-xl border border-green-500/10 group-hover:border-green-500/20 transition-colors duration-300">
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="text-right">
            ...
            <p className="text-green-400 font-semibold">{transfer.amount} NIBI</p>
          </div>
        </div>
        {transfer.remarks && (
      ...
      >
        ...
        <div className="relative bg-black/30 backdrop-blur-xl p-4 rounded-xl border border-green-500/10 group-hover:border-green-500/20 transition-colors duration-300">
          <div className="flex justify-between items-start mb-3">
            ...
            <div className="text-right">
              ...
              <p className="text-green-400 font-semibold">
                {payment.amountCollected} / {payment.totalAmount} NIBI
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-sm text-gray-400 mb-3">
            <span>Per Person: {payment.amountPerPerson} NIBI</span>
      ...
      <div className="relative bg-black/30 backdrop-blur-xl p-4 rounded-xl border border-green-500/10 group-hover:border-green-500/20 transition-colors duration-300">
        <div className="flex justify-between items-start mb-3">
          <div>
            ...
            <p className="text-sm text-gray-400">Target: {pot.targetAmount} NIBI</p>
          </div>
          <div className="text-right">
            <p className="text-sm text-gray-400">Saved</p>
            <p className="text-green-400 font-semibold">{pot.currentAmount} NIBI</p>
          </div>
        </div>
